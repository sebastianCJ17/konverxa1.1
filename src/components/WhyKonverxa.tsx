    ...
    <section className="relative w-full min-h-[90vh] flex items-center bg-[#0e1622] text-white overflow-hidden font-sans border-t border-slate-800">
      ...
      <div className="absolute inset-0 w-full h-full pointer-events-none overflow-hidden">
        <img
          ...
          className="w-full h-full object-cover filter brightness-[0.70] contrast-[1.08] saturate-[1.02]"
        />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-16 sm:py-24">
        <div className="max-w-2xl lg:max-w-3xl space-y-6">
          ...
          <motion.div
            ...
            className="space-y-4 text-slate-200 text-base sm:text-lg leading-relaxed font-normal max-w-2xl pt-1 text-justify"
          >
            <p>
          ...
          >
            <Link
              to="/modelo"
              className="inline-flex items-center gap-3 px-8 py-4 rounded-xl bg-slate-200 hover:bg-white text-slate-950 font-normal text-sm transition-all duration-300 shadow-md hover:shadow-xl group"
            >
