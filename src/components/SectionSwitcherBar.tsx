          ...
          {items.map((item) => {
            ...
            if (isDisabled) {
              return (
                <div
                  ...
                  className={`min-w-max h-9.5 sm:h-10 px-2.5 sm:px-3 rounded-lg text-xs font-normal flex items-center justify-center text-center bg-slate-100/70 text-slate-400 border border-slate-200/60 cursor-not-allowed select-none opacity-60 ${
            ...
            return (
              <button
                ...
                className={`h-9.5 sm:h-10 px-2.5 sm:px-3 lg:px-3 rounded-lg text-xs font-normal uppercase tracking-wider transition-all duration-200 flex items-center justify-center text-center ${
